...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
   ...
   <div style="height:100%" class="panel panel-default" >
     ...
     <tr style="height:100%;margin:10%">
         ...
         <td><asp:TextBox runat="server" class="col-xs-3"  CssClass="form-control" ID="Password"></asp:TextBox></td>
     ...
     <tr style="margin:10%">
         ...
         <td><asp:TextBox runat="server" class="col-xs-3" CssClass="form-control" ID="ConfirmPassword"></asp:TextBox></td>
     ...
     <tr>
       <td></td>
         ...
         <asp:Button runat="server"   class="btn btn-primary" Text="Reset" OnClick="Unnamed11_Click" /></td>
     </tr>
 </table>
   </div>
